...
public class InvoiceApplyLineController extends BaseController {
    ...
    @ApiOperation(value = "Export Invoice Apply Line Data")
    @Permission(level = ResourceLevel.ORGANIZATION)
    @GetMapping("/export")
    @ExcelExport(InvoiceLineDTO.class)
    public ResponseEntity<List<InvoiceLineDTO>> export(InvoiceApplyLine invoiceApplyLine,
                                                                  ExportParam exportParam,
                                                                  HttpServletResponse response,
                                                                  @PathVariable String organizationId) {
        return Results.success(invoiceApplyLineService.exportLine(invoiceApplyLine));
    }
